...
public class SortLoaiStringDSHoaDonStaffViewDialog extends javax.swing.JDialog {
    private MainStaffView mainStaffView;
    private DSHoaDonStaffView dSHoaDonStaffView;
    
    public SortLoaiStringDSHoaDonStaffViewDialog(MainStaffView mainStaffView, DSHoaDonStaffView dSHoaDonStaffView, boolean modal) {
        initComponents();
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = dSHoaDonStaffView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSHoaDonStaffviewController.Sorting(loaiSapXep, 1, dSHoaDonStaffView.getBangDSChuHo());
        }else if(selected.equals("Theo họ và tên")){
            DSHoaDonStaffviewController.Sorting(loaiSapXep, 2, dSHoaDonStaffView.getBangDSChuHo());                
        }else if(selected.equals("Theo Theo tiền")){
            DSHoaDonStaffviewController.Sorting(loaiSapXep, 3, dSHoaDonStaffView.getBangDSChuHo());                
        }else if(selected.equals("Theo tình trạng")){
            DSHoaDonStaffviewController.Sorting(loaiSapXep, 4, dSHoaDonStaffView.getBangDSChuHo());                
        }
    }
