package View.StaffView.QLThongTinChungView.QLTTChungDialog;

import View.AdminView.QLThongTinChungView.QLTTChungDialog.*;
...
//    public  Personal_Infos Ps;
    ...
    public SortLoaiStringTTCDialog(MainStaffView mainStaffView, QLTTChungStaffView qLTTChungStaffView, boolean modal) {
        initComponents();
        this.MainStaffview = mainStaffView;
        this.QlttChungStaffView = qLTTChungStaffView;
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = QlttChungStaffView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSThongTinChung.Sorting(loaiSapXep, 1, QlttChungStaffView.getBangDSTTChung());
        }else if(selected.equals("Theo họ và tên")){
            DSThongTinChung.Sorting(loaiSapXep, 2, QlttChungStaffView.getBangDSTTChung());                
        }else if(selected.equals("Theo địa chỉ")){
            DSThongTinChung.Sorting(loaiSapXep, 3, QlttChungStaffView.getBangDSTTChung());                
        }else if(selected.equals("Theo SĐT")){
            DSThongTinChung.Sorting(loaiSapXep, 4, QlttChungStaffView.getBangDSTTChung());                
        }        
    }
