...
//    public  Personal_Infos Ps;
    ...
    public FilterLoaiDateTTCDialog(MainStaffView mainStaffView, QLTTChungStaffView qLTTChungMainView, boolean modal) {
        ...
        this.QlttChungStaffView = qLTTChungMainView;
    ...
    private void OkBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkBtActionPerformed
        ...
        if(NgayCkb.isSelected()){
            DSThongTinChung.Filter((String)NgayCb.getSelectedItem(), 1, 1, QlttChungStaffView.getBangDSTTChung());
            check = true;
        }
        if(ThangCkb.isSelected()){
            DSThongTinChung.Filter((String)ThangCb.getSelectedItem(), 2, 1, QlttChungStaffView.getBangDSTTChung());
            check = true;
        }
        if(NamCkb.isSelected()){
            DSThongTinChung.Filter(String.valueOf(NamCb.getYear()), 3, 1, QlttChungStaffView.getBangDSTTChung()); 
            check = true;
        }
        if(check)
