...
public class DSChuHoStaffView extends javax.swing.JPanel {
    ...
    public DSChuHoStaffView(MainStaffView msv,int idStafflogin) throws Exception {
        initComponents();
    ...
    private void LamMoiBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LamMoiBtActionPerformed
        try {
            mainStaffView.setForm(new DSChuHoStaffView(this.mainStaffView,this.idStafflogin));
        } catch (Exception ex) {
